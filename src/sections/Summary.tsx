    ...
    <div className="summary-sidebar">
      ...
      <div className="summary-content">
        <div className="summary-item">
          <h3>Career Goal</h3>
          <p>{answers.goal as string || 'Not provided'}</p>
        </div>
        <div className="summary-item">
          <h3>Career Interests</h3>
          <ul>
            {(answers.interests as string[])?.map(interest => <li key={interest}>{interest}</li>) || <li>No interests selected</li>}
          </ul>
        ...
        <div className="summary-item">
          <h3>Skills</h3>
          <ul>
            {(answers.skills as string[])?.map(skill => <li key={skill}>{skill}</li>) || <li>No skills selected</li>}
          </ul>

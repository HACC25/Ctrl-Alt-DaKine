  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      if (json?.path && Array.isArray(json.path) && json.path.length > 0) {
        ...
        const fallback = [
          { id: 'f1', name: 'BIOL 171 - Intro Biology', credits: 3, position: { x: 0, y: 0 } },
          { id: 'f2', name: 'CHEM 161 - General Chemistry', credits: 3, position: { x: 260, y: 0 } },
          { id: 'f3', name: 'MATH 135 - Calculus I', credits: 4, position: { x: 520, y: 0 } }
        ];
